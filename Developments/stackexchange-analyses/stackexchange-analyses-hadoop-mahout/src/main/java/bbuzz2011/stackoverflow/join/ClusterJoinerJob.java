...
/**
 * Joins documents with [document->cluster] file. 
 */
public class ClusterJoinerJob extends Configured {
	...
	public void run() throws Exception {
		...
		String compose = CompositeInputFormat.compose("inner", SequenceFileInputFormat.class, documentPath, clusteredPointsPath);
		// Join two sorted documents 
		// see http://www.congiu.com/joins-in-hadoop-using-compositeinputformat/
		// inner(tbl(org.apache.hadoop.mapred.SequenceFileInputFormat,"target/stackoverflow-output-base/posts"),tbl(org.apache.hadoop.mapred.SequenceFileInputFormat,"target/stackoverflow-output-base/pointsToClusters"))
		job.set("mapred.join.expr", CompositeInputFormat.compose("inner", SequenceFileInputFormat.class, documentPath, clusteredPointsPath));
